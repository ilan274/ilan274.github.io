...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    let objetoQualquer = {};
    assert.deepEqual(createMenu(objetoQualquer), { fetchMenu: {} });
    ...
    // --------------------------------------------------------------------------------------
    // TESTE 3: Verifique que o menu passado pra função createMenu é identico ao menu recuperado pela função
    // 'objetoRetornado.fetchMenu'
    // ```
    assert.deepEqual(objetoRetornado.fetchMenu, objetoQualquer);
    ...
    // passando uma string como parâmetro, como `objetoRetornado.order('coxinha')`, tal string é
    // adicionada ao array retornado em `objetoRetornado.consumption
    // ```;
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    // --------------------------------------------------------------------------------------
    // TESTE 8: Verifique que, ao chamar `objetoRetornado.pay()`, retorna-se a soma dos preços de
    // tudo que foi pedido, conforme registrado em `objetoRetornado.consumption`
    // ```
    // objetoRetornado.order('coxinha');
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
